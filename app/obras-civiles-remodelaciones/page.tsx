...
import { Check, Layout, BrickWall, PaintBucket, Briefcase, ClipboardCheck, ArrowRight, MessageCircle, LucideIcon } from 'lucide-react';
import { obrasData, contactPageData } from '../../data/content';
...
export default function ObrasCiviles() {
    return (
        <div className="animate-in fade-in duration-500">
            {/* 1. Hero Section */}
            <div className="relative pt-28 pb-14 lg:pt-40 lg:pb-20 bg-primary overflow-hidden">
                <div className="absolute inset-0 z-0">
                    {obrasData.hero.image && (
                        <Image
                            src={obrasData.hero.image}
                            alt={obrasData.hero.title}
                            fill
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="max-w-4xl">
                        ...
                        <a
                            href={`https://wa.me/5492615555555?text=${encodeURIComponent(obrasData.hero.whatsappMessage || "")}`}
                            target="_blank"
                            rel="noreferrer"
                ...
                <div className="container mx-auto px-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {obrasData.services.map((service, index) => {
                            const Icon = service.icon ? (iconMap[service.icon] || Layout) : Layout;
                            return (
                ...
                <div className="container mx-auto px-6">
                    <div className="flex flex-col md:flex-row items-center gap-12">
                        <div className="md:w-1/2">
                            ...
                            <a
                                href={`https://wa.me/5492615555555?text=${encodeURIComponent(obrasData.forArchitects.whatsappMessage || "")}`}
                                target="_blank"
                                rel="noreferrer"
            ...
            <section className="bg-white border-t-4 border-secondary py-20 text-center">
                <div className="container mx-auto px-6">
                    ...
                    <a
                        href={`https://wa.me/5492615555555?text=${encodeURIComponent(obrasData.footerCTA.whatsappMessage || "")}`}
                        target="_blank"
                        rel="noreferrer"
