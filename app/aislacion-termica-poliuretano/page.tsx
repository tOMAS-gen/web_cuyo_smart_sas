...
import { insulationPageData } from '../../data/content';
...
export default function AislacionTermica() {
    return (
        <div className="flex flex-col bg-white">
            {/* 1. Hero Section */}
            <section className="relative h-[60vh] min-h-[500px] lg:h-[70vh] flex items-center bg-primary text-white overflow-hidden">
                <div className="absolute inset-0 z-0">
                    {insulationPageData.hero.image && (
                        <Image
                            src={insulationPageData.hero.image}
                            alt={insulationPageData.hero.title}
                            fill
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="max-w-4xl">
                        ...
                        <a
                            href={`https://wa.me/5492615555555?text=${encodeURIComponent(insulationPageData.hero.whatsappMessage || "")}`}
                            target="_blank"
                            rel="noreferrer"
                        ...
                        {insulationPageData.applications.map((app, index) => (
                            <div key={index} className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-100 hover:border-secondary/30 transition-all duration-500">
                                ...
                                <div className="w-full h-[400px] relative overflow-hidden">
                                    <div className="absolute inset-0 bg-primary">
                                        ...
                                        <div className="w-full h-full bg-gray-200 flex items-center justify-center text-gray-400">
                                            ...
                                            <Image
                                                src={insulationPageData.hero.image || "/home/aislacion.jpeg"}
                                                alt={app.title}
                                                fill
                                ...
                                <div className="p-10 md:p-12 bg-white">
                                    ...
                                    <a
                                        href={`https://wa.me/5492615555555?text=${encodeURIComponent(app.whatsappMessage || "")}`}
                                        target="_blank"
                                        rel="noreferrer"
            ...
            <section className="bg-primary py-24 text-center border-t border-white/10 relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    ...
                    <a
                        href={`https://wa.me/5492615555555?text=${encodeURIComponent(insulationPageData.footerCTA.whatsappMessage || "")}`}
                        target="_blank"
                        rel="noreferrer"
